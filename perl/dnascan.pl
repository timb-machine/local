...
#  purpose:     Look for common misconfigurations and information leaks in ASP.NET applications
...
{
    print STDERR "[*] Please specify the complete URL (ex: http://www.site.int/page.aspx)\n\n";
    exit(0);
}
...
{
    print " " . (" " x (12 - length($_))) . $_ . "\t-> " . $options{$_} . "\n"; 
}
...
sub usage { 
    print STDERR "usage: $0 http://server/application/startpage.aspx\n\n"; 
    exit(1); 
}
